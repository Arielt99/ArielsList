        ...
        <template #header>
            <h2 class="flex flex-row font-semibold text-xl text-gray-800 leading-tight">
                ...
                <div>
                    ...
                    <span class="inline-flex items-center" v-if="current_category">
                        >
                    </span>
                    ...
                    <span class="inline-flex items-center" v-if="current_subcategory">
                        >
                    </span>
                ...
                <div v-if="route_name == 'search'">
                    <span class="inline-flex items-center" v-if="search_content">
                        >
                    </span>
